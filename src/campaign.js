 ...
 */
 class CampaignException {
  ...
  static NEW_INSTANCE_FAILED(entityType, details)         { return new CampaignException(undefined, 500, 16384, `SDK-000014 "Failed to create new instance for ${entityType}`, details); }
