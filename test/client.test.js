...
describe('ACC Client', function () {
    ...
    describe("getReport API", () => {
        ...
        it("Should fail to call getReport API", async () => {
            ...
            await expect(client.getReport({
                reportName: "throughput",
                context: "selection",
                selection: "12133",
                selectionCount: 1
            })).rejects.toMatchObject({ statusCode:500, message:"500 - Error 16384: SDK-000014 \"Failed to fetch report throughput. 500 - Error calling method '/report/throughput?_noRender=true&_context=selection&_selection=12133&_selectionCount=1': Error rc=-57" });
